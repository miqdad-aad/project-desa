...
Route::group(['middleware' => ['web', 'auth']], function () {
    ...
    Route::get('/kematian.index', 'KematianController@index')->name('kematian.index');
    Route::get('/kematian.create', 'KematianController@create')->name('kematian.create');
    Route::post('/kematian.store', 'KematianController@store')->name('kematian.store');

    Route::get('/kelahiran.index', 'KelahiranController@index')->name('kelahiran.index');
    Route::get('/create', 'KelahiranController@create')->name('kelahiran.create');
    Route::post('/store', 'KelahiranController@store')->name('kelahiran.store');

    Route::get('/mutasimasuk.index', 'MutasimasukController@index')->name('mutasimasuk.index');
    Route::get('/mutasimasuk.create', 'MutasimasukController@create')->name('mutasimasuk.create');
    Route::post('/mutasimasuk.store', 'MutasimasukController@store')->name('mutasimasuk.store');

    Route::get('/mutasikeluar.index', 'MutasikeluarController@index')->name('mutasikeluar.index');
    Route::get('/mutasikeluar.create', 'MutasikeluarController@create')->name('mutasikeluar.create');
    Route::post('/mutasikeluar.store', 'MutasikeluarController@store')->name('mutasikeluar.store');
