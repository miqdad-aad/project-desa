            ...
            <div class="card-body">
                <form autocomplete="off" action="{{ route('penduduk.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="status_tinggal">Status Tinggal</label>
                            <select class="form-control @error('status_tinggal') is-invalid @enderror" name="status_tinggal" id="status_tinggal">
                                <option selected value="">Pilih Status</option>
                                <option value="1" {{ old('status_tinggal') == 1 ? 'selected="true"' : ''  }}>Asli</option>
                                <option value="2" {{ old('status_tinggal') == 2 ? 'selected="true"' : ''  }}>Non Asli</option>
                                <option value="3" {{ old('status_tinggal') == 3 ? 'selected="true"' : ''  }}>Musiman</option>
                            </select>
                            @error('status_tinggal')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                    </div>
