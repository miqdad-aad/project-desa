                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div
                            ...
                            <div class="mb-3">
                                <a href="{{ url('/mutasikeluar.create') }}" class="btn btn-success" title="Tambah"><i
                                        class="fas fa-plus"></i> Tambah Mutasi Keluar</a>
                            </div>
                        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-sm table-striped table-bordered">
                <thead>
                    ...
                    <th class="text-center">Desa Mutasi</th>
                    <th class="text-center">kecamatan Mutasi</th>
                    <th class="text-center">Kabupaten Mutasi</th>
