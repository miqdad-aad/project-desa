                    ...
                    <div class="card animate-up shadow">
                        ...
                        <div class="card-body text-center">
                            <a href="{{ route('pemerintahan-desa.show', ['pemerintahan_desa' => $item, 'slug' => Str::slug($item->judul)]) }}">
                                <h3>{{ $item->judul }}</h3>
                                <div class="mt-3 d-flex justify-content-between text-sm text-muted">
                                    <i class="fas fa-clock"> Created: {{ $item ? $item->diffForHumans: '-' }}</i>
                                    <i class="fas fa-eye"> {{ $item->dilihat }} Kali Dibaca</i>
                                </div>
                            </a>
                        </div>
...
@endif
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31661.75310702082!2d112.5489342685108!3d-7.27276661402775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78012b890cc9ed%3A0xcc0766fe3cbfc8ed!2sBoteng%2C%20Kec.%20Menganti%2C%20Kabupaten%20Gresik%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1637665938061!5m2!1sid!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
@endsection
