                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div
                            ...
                            <div class="mb-3">
                                <h2 class="mb-0">Kelahiran</h2>
                                <p class="mb-0 text-sm">Kelola Kelahiran</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route('kelahiran.create') }}" class="btn btn-success" title="Tambah"><i
                                        class="fas fa-plus"></i> Tambah Kelahiran</a>
                            </div>
                        </div>
